...
class Chat:
    def __init__(self):
        self.sessions={}
        self.users = {}
        self.users['ihsan']={ 'nama': 'Ihsan 1', 'negara': 'Argentina', 'password': 'surabaya', 'incoming' : {}, 'outgoing': {}}
        self.users['widagdo']={ 'nama': 'Ihsan 2', 'negara': 'Inggris', 'password': 'surabaya', 'incoming': {}, 'outgoing': {}}
        self.users['santoso']={ 'nama': 'Ihsan 3', 'negara': 'Inggris', 'password': 'surabaya','incoming': {}, 'outgoing':{}}
        self.groups = {}
        self.realms = {}
        self.realms_info = {}
...
#     print(sesi)
    # sesi = j.autentikasi_user('ihsan','surabaya')
    # print (sesi)
    # register = j.register("Ihsan", "Indonesia", "ihsan", "surabaya")
    # print(register)
...
#     print(j.get_inbox('henderson'))
    ...
    sesi = j.proses("auth ihsan surabaya")
    print(sesi)
